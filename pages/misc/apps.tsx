	...
	return (
		<div className={styles.app}>
			...
			<div className={styles.container}>
				...
				<p>
					The following is a list of free, safe, and open-source Android mods for your convenience
					(click for details)
				</p>
				<div className={styles.box}>
					...
					<details className={styles.listItem}>
						...
						<div className={styles.content}>
							...
							<p>
								Also consider <a href="https://tachiyomi.org/forks/TachiyomiSY/">TachiyomiSY</a>{" "}
								<a href="https://tachiyomi.org/forks/TachiyomiSY/">{/* <DownloadIcon /> */}</a>
							</p>
							<p>
								Source code for <a href="https://github.com/tachiyomiorg/tachiyomi">original</a> and{" "}
			...
			<footer className={styles.footer}>
				<p>
					Contact: <a href="mailto:sia@siarune.dev">sia@siarune.dev</a> | Liscenced under GPLv3
				</p>
			</footer>
		</div>
	);
